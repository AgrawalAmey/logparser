...
class LogParser():
    ...
    def parse(self, log_file):
        ...
        df_event['EventTemplate'] = [x for (x, y) in  event_and_match_length_dict.iteritems()]
        df_event['Occurrences'] = df_event['EventTemplate'].map(occ_dict)
        df_event['Average Match Length'] = [y for (x, y) in  event_and_match_length_dict.iteritems()]
