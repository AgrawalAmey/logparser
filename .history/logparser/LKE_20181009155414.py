...
class Para:
    ...
    rex=[('core\.[0-9]*', 'core.')],savePath='./results/',saveFileName='template'):# line 55,change the regular expression replacement code
        self.path=path
...
para = Para(rex=rex, path=path, logname=logName, removeCol=removeCol, removable=True)
myparser=LKE(para)
